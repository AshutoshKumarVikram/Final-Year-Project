...
for count in range (0,100):
    ...
    if(count==10):
        ...
        s.starttls()  
        s.login("mr.ashutoshkumarvikram@gmail.com", "ashu@singh")  
        message = "there is a movement in the area" 
        s.sendmail("mr.ashutoshkumarvikram@gmail.com", "mr.ashutoshkumarvikram@gmail.com",message) 
        s.quit()
